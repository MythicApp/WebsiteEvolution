...
const sendInEmail = (name, url) => {
  var subject = `Mythic Release ${name}`;
  var body = url;
            ...
            <Stack gap={2} style={{ position: 'sticky', top: 96 }}>
              <ReleaseTile>
                <Stack gap>
                  ...
                  <Stack direction="horizontal" align="center" distribute="space-between" style={{ width: '100%' }}>
                    <Stack direction="horizontal" align="center" gap={1}>
                      ...
                      {hasGithubFallback ? (
                        <Button size="sm" href={githubDownloadUrl}>
                          <GithubSvg style={{ marginRight: 6, width: 15, height: 15, verticalAlign: 'middle' }} />
                          Mirror
                        </Button>
                      ) : null}
                    </Stack>
